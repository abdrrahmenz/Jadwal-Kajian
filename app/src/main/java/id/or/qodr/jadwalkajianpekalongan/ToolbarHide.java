...
/**
 * Created by adul on 28/04/17.
 */

public class ToolbarHide extends RecyclerView.OnScrollListener {
    ...
    public ToolbarHide(View toolbarContainer, View toolbar, View lastToolbarView) {
        this(toolbarContainer, toolbar, lastToolbarView, null);
    }

    public ToolbarHide(View toolbarContainer, View toolbar, View lastToolbarView, View parallaxScrollingView) {
